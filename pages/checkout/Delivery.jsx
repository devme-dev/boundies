...
const Delivery = ({ router, setReferal }) => {
    ...
    useEffect(() => {
        setReferal(`${JSON.stringify(formData)} &&&&&&&&&&&& ${JSON.stringify(formData2)}`)
    }, [formData, formData2])
    ...
    return (
        <div className={styles.contactInformation}>
            ...
            <div className={styles.shippingOptions}>
                <FormControlLabel
                    ...
                    label="US Shipping ($1.90)"
                    value="us"
                    onChange={handleShippingOptionChange}
                />
                {shippingOption === 'us' && (<p>Fast shipping in 2 days.</p>)}
                <FormControlLabel
                    control={<Radio name="shipping" checked={shippingOption === 'worldwide'} />}
                    label="Worldwide Shipping ($9.90)"
                    value="worldwide"
                    onChange={handleShippingOptionChange}
                />
                {shippingOption === 'worldwide' && (<p>Your order will be fulfilled and sent to USPS in 1 day. Standard shipping in 5-10 days.</p>)}
            </div>
            {shippingOption && (
      ...
      <div className={styles.infoForm}>
        ...
        <div className={styles.row}>
          ...
          />
          <TextField label="City" name="city" value={formData.city} onChange={handleChanges} required />
        </div>
        <div className={styles.row}>
          <TextField label="State" name="state" value={formData.state} onChange={handleChanges} />
          <select className={styles.muiStyleSelect} name="country" value={formData.country} onChange={handleChanges}>
        ...
        />
                    ...
                    <FormControlLabel
                        control={<Checkbox checked={billingAddressSameAsShipping} onChange={handleBillingAddressChange} />}
                    ...
                    {billingAddressSameAsShipping === false && (
                        ...
                        <div className={styles.infoForm}>
                          ...
                          <div className={styles.row}>
                            ...
                            <select className={styles.muiStyleSelect} name="country" value={formData2.country} onChange={handleChanges2}>
                              <option value="" disabled>
                                Country
                              </option>
                              {countries.map((country) => (
            ...
            <div className={styles.contactButton}>
                <Button variant="contained" color="primary" onClick={handleProceed} disabled={!shippingOption}>Continue To Payment</Button>
            </div>
        </div>
    );
};
