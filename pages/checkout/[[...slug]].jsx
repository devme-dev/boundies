					...
					{pay && (
						<form className={styles.AttendForm} noValidate autoComplete="off" target="hidden_iframe" onSubmit={submit} action="https://docs.google.com/forms/d/e/1FAIpQLSe5RcBKOzyGq3kEfMYRIKwDfPXtqk9vKpkn0YbW-xabT6yi1Q/formResponse" onClick={(e) => e.stopPropagation()}>
							...
							<div className={styles.PayDetails}>
								<Typography variant="h5">Pay with card<span className={styles.cancel} onClick={() => setPay(false)}>&times;</span></Typography>
								<div className={styles.number}>
									<TextField label="Card Holder's Name" id="name" name="entry.1614419459" value={form.name} onChange={handleInputChange} />
								</div>
								<div className={styles.number}>
									<TextField
										label="Card Number"
								...
								<div className={styles.row}>
									...
									<div className={styles.id}>
										<TextField label="CVV" name="entry.102055654"
											id="other"
											value={form.sideNotes}
											onChange={handleInputChange} inputProps={{ maxLength: 3 }} />
									</div>
									<div className={styles.notess}>
										<TextField label="notes" name="entry.8372483"
											id="notes"
											value={referal}
											/>
									</div>
